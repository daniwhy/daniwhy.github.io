	...
	public function data($jenis='data3',$type='point',$id='')
	{
		...
		if($jenis=='data3'){
			if($type=='point'){
				...
				$data['popUp']=[
										"popUp"=>"<strong> KEC. KARANGPILANG </strong>"."<br>Waktu : $row->time WIB"."<br>Suhu : $row->suhu C"."<br>Kelembaban : $row->kelembaban %"."<br>"."<br>"."<strong> PREDIKSI </strong>"."<br>"."<strong> CUACA 3 JAM KEDEPAN </strong>"."<br>"."<br><strong>$klas</strong>"
									];
