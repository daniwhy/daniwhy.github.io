	...
	public function data($jenis='data2',$type='point',$id='')
	{
		...
		if($jenis=='data2'){
			if($type=='point'){
				...
				$data['popUp']=[
											"popUp"=>"<strong> KEC. TEGALSARI </strong>"."<br>Waktu : $row->time WIB"."<br>Suhu : $row->suhu C"."<br>Kelembaban : $row->kelembaban %"."<br>"."<br>"."<strong> PREDIKSI </strong>"."<br>"."<strong> CUACA 3 JAM KEDEPAN </strong>"."<br>"."<br><strong>$klas</strong>"
										];
