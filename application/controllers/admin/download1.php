...
class download1 extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('downloadModels1','Model');
	}
	...
	public function index()
	{
		...
		$config['base_url'] = 'http://localhost/webcuaca/admin/download1/index';
		...
		$data['content']=$this->load->view('admin/download/downloadView1',$datacontent,TRUE);
	...
	public function export(){
		...
		header('Content-Disposition: attachment; filename="Data Cuaca GSI-1.csv"'); // Set nama file excel nya
