...
class download2 extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('downloadModels2','Model');
	}
	...
	public function index()
	{
		...
		$config['base_url'] = 'http://localhost/webcuaca/admin/download2/index';
		...
		$data['content']=$this->load->view('admin/download/downloadView2',$datacontent,TRUE);
	...
	public function export(){
		...
		header('Content-Disposition: attachment; filename="Data Cuaca TGL-1.csv"'); // Set nama file excel nya
